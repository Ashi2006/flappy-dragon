...
setInterval(() => {
    if(checkcollision(document.getElementById("dragon"),document.getElementById("pipe1"))){
    ...
    else if(checkcollision(document.getElementById("dragon"),document.getElementById("pipe2"))){
        elem.style.top=513+"px";
        setTimeout(() => {
            alert("You Lost!! Your Score is: "+score);
            return;
